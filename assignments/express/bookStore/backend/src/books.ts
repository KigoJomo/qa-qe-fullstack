...
export const books: Book[] = [
  ...
  },
  {
    ...
    description:
      "A story about Holden Caulfield's experiences in New York City after being expelled from prep school.",
  ...
  },
  {
    ...
    description:
      "A fantasy novel about the adventures of Bilbo Baggins, a hobbit, who sets out on a quest to win a share of a dragon's treasure.",
  ...
  },
  {
    ...
    description:
      "A dystopian novel about a future society where books are banned, and 'firemen' burn any that are found.",
  ...
  },
  {
    ...
    publisher: 'Unknown',
    description:
      'An epic poem that follows the Greek hero Odysseus on his journey home after the fall of Troy.',
